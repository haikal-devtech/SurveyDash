    ...
    <div className="min-h-screen flex items-center justify-center bg-muted/50 p-6">
      ...
      >
        <div className="flex flex-col items-center mb-8 gap-3">
          ...
          <h1 className="text-3xl font-bold tracking-tight">SurveyDash</h1>
          <p className="text-muted-foreground text-center">
            Sistem Informasi Pengolahan & Pemaparan Hasil Survei SKM
          </p>
        </div>
        ...
        <Card className="border-none shadow-xl overflow-hidden relative">
          ...
          <CardHeader className="space-y-1">
            ...
            <CardDescription>
              Masuk menggunakan akun Google Anda yang terdaftar di sistem.
            </CardDescription>
          </CardHeader>
