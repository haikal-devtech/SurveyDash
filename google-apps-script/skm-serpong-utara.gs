/**
 * skm-serpong-utara.gs — Google Apps Script untuk SurveyDash
 * Survei Kepuasan Masyarakat (SKM) Kecamatan Serpong Utara
 * Kota Tangerang Selatan — Semester 1 Tahun 2026
 ...
 *   Indeks kolom di bawah (COL_*) diasumsikan mengikuti URUTAN pertanyaan pada
 *   kuesioner ini, dengan kolom A = Timestamp otomatis Google Form (indeks 0).
 *   WAJIB cek header sheet respons Anda dan sesuaikan angka-angka di blok CFG bila
 *   urutan/isi form berbeda. Indeks dimulai dari 0 (Kolom A = 0, B = 1, C = 2, ...).
 */
...
const CFG = {
  ...
  // — Meta survei —
  SURVEY_NAME: 'SKM Kecamatan Serpong Utara',
  PERIOD:      'Semester 1 Tahun 2026',
  TARGET_RESPONDENTS: 400,

  // — Pemetaan kolom (indeks 0-based; Kolom A = 0) —
  // Disesuaikan dengan header sheet respons SKM Serpong Utara.
  ...
  COL_LOKASI:     10,  // K: Kelurahan (dipakai sebagai lokasi)
